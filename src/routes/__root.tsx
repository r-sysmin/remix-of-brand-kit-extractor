  ...
  head: () => ({
    meta: [
      ...
      { title: "Brand DNA" },
      {
        name: "description",
        content:
          "Get any site's full brand guide with logos, typography, colors and voice just by entering a URL.",
      },
      {
        name: "keywords",
        content: "brand kit, design system, color extraction, typography, brand voice, design tokens",
      },
      { property: "og:site_name", content: "Brand DNA" },
      { property: "og:title", content: "Brand DNA — brand design system extractor" },
      {
        property: "og:description",
        content: "Get any site's full brand guide with logos, typography, colors and voice just by entering a URL.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Brand DNA — brand design system extractor" },
